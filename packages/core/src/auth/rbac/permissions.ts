...
export const PERMISSIONS = {
  ...
  VENDORS_MANAGE_KYC: "vendors.manage_kyc",
  VENDORS_MANAGE_PAYOUTS: "vendors.manage_payouts",
...
> = {
  ...
  [PERMISSIONS.VENDORS_VIEW]: {
    ...
    description: "View marketplace vendor profiles and onboarding status",
    resource: "vendors",
    action: "view",
    category: "Vendors",
    isSensitive: false,
  ...
  [PERMISSIONS.VENDORS_CREATE]: {
    ...
    description: "Create marketplace vendor profiles",
    resource: "vendors",
    action: "create",
    category: "Vendors",
    isSensitive: false,
  ...
  [PERMISSIONS.VENDORS_EDIT]: {
    name: PERMISSIONS.VENDORS_EDIT,
    displayName: "Edit Vendors",
    description: "Edit marketplace vendor profile, owner, and commission details",
    resource: "vendors",
    action: "edit",
    category: "Vendors",
    isSensitive: false,
  ...
  [PERMISSIONS.VENDORS_MANAGE_STATUS]: {
    name: PERMISSIONS.VENDORS_MANAGE_STATUS,
    displayName: "Manage Vendor Status",
    description: "Approve, reject, suspend, or reactivate marketplace vendors",
    resource: "vendors",
    action: "manage_status",
    category: "Vendors",
    isSensitive: true,
  },
  [PERMISSIONS.VENDORS_MANAGE_KYC]: {
    name: PERMISSIONS.VENDORS_MANAGE_KYC,
    displayName: "Manage Vendor KYC",
    description: "Review and update marketplace vendor KYC documents",
    resource: "vendors",
    action: "manage_kyc",
    category: "Vendors",
    isSensitive: true,
  },
  [PERMISSIONS.VENDORS_MANAGE_PAYOUTS]: {
    name: PERMISSIONS.VENDORS_MANAGE_PAYOUTS,
    displayName: "Manage Vendor Payouts",
    description: "Review and update vendor payout account readiness",
    resource: "vendors",
